...
class environment(object):
    ...
    def update_env(self, direction, energy_ai, month):
        ...
        self.current_number_users += np.random.radiant(-self.max_update_users, self.max_update_users)
        if(self.current_number_users > self.max_number_users):
            ...
            self.intrinsic_temperature = self.atmospheric_temperature + 1.25 * self.current_number_users +1.25 * self.current_rate_data
            delta_intrinsic_tenperature = self.intrinsic_temperature - past_intrinsic_temperature
            ...
            self.temperature_ai += delta_intrinsic_tenperature + delta_temperature_ai
            
            self.temperature_noai += delta_intrinsic_tenperature
